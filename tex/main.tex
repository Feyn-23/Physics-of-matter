...
\textbf{\huge    Appunti di Fisica della Materia }

\vspace{2cm}

\begin{figure}[h]\label{logo}
    \includegraphics[width= .4 \textwidth]{../figs/logo.jpg}
    \centering
\end{figure}
...
\noindent
\includegraphics[scale=0.5]{../figs/cc} All materials are licensed under the \href{http://creativecommons.org/licenses/by-sa/3.0/us/}{Creative Commons Attribution-Share Alike 3.0 United States License.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
